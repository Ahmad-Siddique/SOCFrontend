const Menu = [
  ...
  { is_divider: true },
  { path: "/createclient", icon: "bi bi-bar-chart", title: "CREATE CLIENT" },

  { is_divider: true },
  { path: "/allclients", icon: "bi bi-bar-chart", title: "ALL CLIENTS" },
  { is_divider: true },
  { path: "/createtask", icon: "bi bi-bar-chart", title: "CREATE TASK" },
  { is_divider: true },
  { path: "/alltasks", icon: "bi bi-bar-chart", title: "ALL TASKS" },
  // {
  //   path: "/email",
  //   icon: "bi bi-envelope",
  //   title: "Email",
