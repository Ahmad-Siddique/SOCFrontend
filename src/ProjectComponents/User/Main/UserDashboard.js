                    ...
                    <div className="col-lg-6 mb-3 mb-lg-0" key={index}>
                      <div className="d-flex">
                        ...
                        <div className="ps-3 flex-1">
                          <div className="fs-10px fw-bold text-white text-opacity-50 mb-1">
                            {server.name}
                          </div>
                            ...
                            <div className="d-flex">
                              ...
                              >
                                ...
                                <div className="position-absolute top-0 start-0">
                                  <span
                                    className={
                                      "badge rounded-0 d-flex align-items-center justify-content-center w-20px h-20px" +
                                      (index < 3
                              ...
                              <div className="flex-1 ps-3">
                                <div className="mb-1">
                                  <small className="fs-9px fw-500 lh-1 d-inline-block rounded-0 badge bg-white bg-opacity-25 text-white text-opacity-75 pt-5px">
                                    {product.sku}
                                  </small>
                                </div>
                            ...
                            >
                              <tbody>
                                <tr>
                                  ...
                                  <td className="text-white text-opacity-75 fw-500">
                                    {product.qty}
                                  </td>
                                </tr>
                                <tr>
